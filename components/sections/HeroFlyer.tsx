    ...
    <>
      <section className="bg-stone overflow-hidden">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 md:pt-24 pb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div className="order-last md:order-first">
                ...
                <div className="grid grid-cols-5 gap-2 md:gap-3">
                  {BHRT_BENEFITS.map(({ label, icon }) => (
                    <div key={label} className="flex flex-col items-center gap-1.5 text-center">
                      ...
                      <p className="text-[10px] md:text-xs text-clay leading-tight">{label}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <p className="text-clay/80 text-sm italic leading-relaxed">
        ...
        <div className="bg-forest py-7 px-4">
          <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs md:text-sm">Trusted Education. Proven Care.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-stone py-12 px-4 text-center">
          ...
          <p className="text-clay mb-1">Convenient. Confidential. Compassionate.</p>
          <p className="font-semibold text-bark mb-1">
            BOOK YOUR VIRTUAL VISIT WITH{" "}
            <Link href="/contact#booking" className="text-forest underline underline-offset-4 hover:text-moss transition-colors">
              KIM TODAY!
            </Link>
          </p>
          <p className="text-sm text-clay/70 mb-8">Your path to balance starts here.</p>
          <Link
